    ...
    components: {
      securitySchemes: {
        cookieAuth: {
          ...
          in: 'cookie',
          name: 'connect.sid',
          description: 'Session cookie obtained after Google OAuth login. Visit /auth/google to authenticate.'
        }
      },
      schemas: {
        Book: {
          ...
          properties: {
            ...
            description: { type: 'string', example: 'A classic novel set in the Jazz Age.' },
        ...
        Author: {
          ...
          properties: {
            ...
            genres: { type: 'array', items: { type: 'string' }, example: ['Fiction', 'Literary Fiction'] },
            biography: { type: 'string', example: 'Francis Scott Key Fitzgerald was an American novelist...' },
        ...
        Member: {
          ...
          properties: {
            ...
            address: { type: 'string', example: '123 Main St, Springfield, IL' },
            membershipType: { type: 'string', enum: ['basic', 'premium', 'student'], example: 'basic' },
        ...
        Loan: {
          ...
          properties: {
            ...
            returnDate: { type: 'string', format: 'date', example: '2024-06-10' },
